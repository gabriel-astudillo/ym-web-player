...
export const AYM_HardwarePresetsData = {
    ...
    // En assets/js/aym-hw-presets.js dentro de AYM_HardwarePresetsData:
    
    iFeelLove: {
        title: "I Feel Love (Bassline & Drums)",
        framerate: 50,
        nFrames: 48, // 16 semicorcheas x 3 frames = 48 frames (1 compás a ~125 BPM)
        songData: [
            // =========================================================================
            // PASO 01: Bombo + Bajo C2 (R0-R1: 0x9E, 0x06 | R6: 0x18 | Mixer: 0x36)
            // =========================================================================
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x18, 0x36, 0x0F, 0x00, 0x0F, 0x00, 0x00, 0x00,
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x1A, 0x36, 0x0B, 0x00, 0x08, 0x00, 0x00, 0x00,
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 02: Bajo C3 (R0-R1: 0x4F, 0x03 | Mixer: 0x3E)
            // =========================================================================
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 03: Hi-Hat + Bajo Eb2 (R0-R1: 0x91, 0x05 | R6: 0x01 | Mixer: 0x16)
            // =========================================================================
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0F, 0x00, 0x0D, 0x00, 0x00, 0x00,
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0B, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 04: Bajo Eb3 (R0-R1: 0xC8, 0x02)
            // =========================================================================
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 05: Bombo + Caja + Bajo F2 (R0-R1: 0xF5, 0x04 | R6: 0x12 | Mixer: 0x16)
            // =========================================================================
            0xF5, 0x04, 0x00, 0x00, 0x00, 0x00, 0x12, 0x16, 0x0F, 0x00, 0x0F, 0x00, 0x00, 0x00,
            0xF5, 0x04, 0x00, 0x00, 0x00, 0x00, 0x14, 0x16, 0x0B, 0x00, 0x08, 0x00, 0x00, 0x00,
            0xF5, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 06: Bajo F3 (R0-R1: 0x7A, 0x02)
            // =========================================================================
            0x7A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x7A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x7A, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 07: Hi-Hat + Bajo G2 (R0-R1: 0x6B, 0x04 | R6: 0x01 | Mixer: 0x16)
            // =========================================================================
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0F, 0x00, 0x0D, 0x00, 0x00, 0x00,
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0B, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 08: Bajo G3 (R0-R1: 0x35, 0x02)
            // =========================================================================
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 09: Bombo + Bajo Bb2 (R0-R1: 0xB7, 0x03 | R6: 0x18 | Mixer: 0x36)
            // =========================================================================
            0xB7, 0x03, 0x00, 0x00, 0x00, 0x00, 0x18, 0x36, 0x0F, 0x00, 0x0F, 0x00, 0x00, 0x00,
            0xB7, 0x03, 0x00, 0x00, 0x00, 0x00, 0x1A, 0x36, 0x0B, 0x00, 0x08, 0x00, 0x00, 0x00,
            0xB7, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 10: Bajo Bb3 (R0-R1: 0xDB, 0x01)
            // =========================================================================
            0xDB, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xDB, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xDB, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 11: Hi-Hat + Bajo G2 (R0-R1: 0x6B, 0x04 | R6: 0x01 | Mixer: 0x16)
            // =========================================================================
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0F, 0x00, 0x0D, 0x00, 0x00, 0x00,
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0B, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x6B, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            // =========================================================================
            // PASO 12: Bajo G3 (R0-R1: 0x35, 0x02)
            // =========================================================================
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x35, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            // =========================================================================
            // PASO 13: Bombo + Caja + Bajo Eb2 (R0-R1: 0x91, 0x05 | R6: 0x12 | Mixer: 0x16)
            // =========================================================================
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x12, 0x16, 0x0F, 0x00, 0x0F, 0x00, 0x00, 0x00,
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x14, 0x16, 0x0B, 0x00, 0x08, 0x00, 0x00, 0x00,
            0x91, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 14: Bajo Eb3 (R0-R1: 0xC8, 0x02)
            // =========================================================================
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0xC8, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            // =========================================================================
            // PASO 15: Hi-Hat + Bajo C2 (R0-R1: 0x9E, 0x06 | R6: 0x01 | Mixer: 0x16)
            // =========================================================================
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0F, 0x00, 0x0D, 0x00, 0x00, 0x00,
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 0x0B, 0x00, 0x06, 0x00, 0x00, 0x00,
            0x9E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,

            // =========================================================================
            // PASO 16: Bajo C3 (R0-R1: 0x4F, 0x03)
            // =========================================================================
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x4F, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3E, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00
